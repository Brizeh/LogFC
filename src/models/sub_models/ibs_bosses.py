...
class FRAENIR(Boss):
    ...
    def get_frozen_mvp(self):
        ...
        if max_frozen > 1:
            ...
            if len(i_players) > 1:
                return self.msg("FRAENIR MVP FROZEN P", mvp_names=mvp_names, max_frozen=max_frozen)
            return self.msg("FRAENIR MVP FROZEN S", mvp_names=mvp_names, max_frozen=max_frozen)
        return
