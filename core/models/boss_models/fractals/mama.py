"""
Module contenant la classe représentant le boss MAMA des fractales.
"""
...
class MAMA(Boss):
    """
    Classe représentant le boss MAMA des fractales.

    Attributes:
        last (MAMA): Dernière instance créée de cette classe
    ...
    def __init__(self, log: Log):
        """
        Initialise une instance de MAMA.
