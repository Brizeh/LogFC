"""
Module contenant la classe représentant le boss SKORVALD des fractales.
"""
...
class SKORVALD(Boss):
    """
    Classe représentant le boss SKORVALD des fractales.
    
    Attributes:
        last (SKORVALD): Dernière instance créée de cette classe
    ...
    def __init__(self, log: Log):
        """
        Initialise une instance de SKORVALD.
