"""
Module contenant la classe représentant le boss ARTSARIIV des fractales.
"""
...
class ARTSARIIV(Boss):
    """
    Classe représentant le boss ARTSARIIV des fractales.
    
    Attributes:
        last (ARTSARIIV): Dernière instance créée de cette classe
    ...
    def __init__(self, log: Log):
        """
        Initialise une instance de ARTSARIIV.
