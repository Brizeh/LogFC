"""
Module contenant la classe représentant le boss EPARCH des fractales.
"""
...
class EPARCH(Boss):
    """
    Classe représentant le boss EPARCH des fractales.
    
    Attributes:
        last (EPARCH): Dernière instance créée de cette classe
    ...
    def __init__(self, log: Log):
        """
        Initialise une instance de EPARCH.
