...
from src.models.player_class import *
...
class Boss:  
    ...
    def get_lvp_dps(self):
        ...
        self.add_lvps(i_players) 
        if foodSwapCount:
            return language_config.selected_language["LVP DPS FOODSWAP"].format(lvp_dps_name=lvp_dps_name, max_dmg=max_dmg, dmg_ratio=dmg_ratio, dps=dps, foodSwapCount=foodSwapCount)
        return language_config.selected_language["LVP DPS"].format(lvp_dps_name=lvp_dps_name, max_dmg=max_dmg, dmg_ratio=dmg_ratio, dps=dps)
    ################################ DATA BOSS ################################
